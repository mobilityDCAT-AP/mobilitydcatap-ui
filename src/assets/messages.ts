...
const bundles: Record<string, Messages> = {
  en: {
    ...
    toolbarHint: 'Fill the form and click "Generate RDF" to obtain mobilityDCAT-AP metadata.',
  ...
  it: {
    ...
    toolbarHint: 'Compila il form e clicca "Genera RDF" per ottenere i metadati in mobilityDCAT-AP.',
